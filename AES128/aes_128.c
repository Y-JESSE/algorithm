...
/**
 * @description: aes-128加密/解密函数，只支持aes128，不支持aes-192及aes-256
 * @param *state  需要加密/解密的数据
 * @param *key    加密/解密密钥
 * @param dir     0-加密，1-解密
 */
void aes128_enc_dec(unsigned char *state, unsigned char *key, unsigned char dir)
{
